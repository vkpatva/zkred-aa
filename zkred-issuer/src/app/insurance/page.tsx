...
function InsuranceContent() {
  ...
  const steps = [
    ...
    {
      title: "Give Consent",
      description: "Authorize access to your Insurance details",
      icon: "✅",
    },
    {
      title: "Generate Credentials",
      description: "Create verifiable Insurance credentials",
      icon: "🔐",
    },
    {
  ...
  useEffect(() => {
    const handleRedirect = async () => {
      ...
      if (fi && resdate && ecres) {
        ...
        try {
          const response = await fetch("/api/insurance/decode-redirect", {
            method: "POST",
            headers: {
          ...
          if (data) {
            ...
            setError("Failed to process insurance response. Please try again.");
          }
        } catch (error) {
          setError("Failed to process insurance response. Please try again.");
          console.error(error);
  ...
  const handleGenerateConsent = async () => {
    ...
    try {
      const response = await fetch("/api/insurance/generate-consent", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleIssueCredentials = async () => {
    ...
    try {
      const response = await fetch(
        `/api/insurance/issue-credential?dataId=${dataId}`,
        {
          method: "GET",
        }
      );
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-12">
          Insurance Account Verification
        </h1>
        ...
        <div className="bg-white shadow rounded-lg p-8">
          {currentStep === 1 && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Please enter your insurance-registered mobile number
              </p>
              <input
                type="tel"
                value={mobileNumber}
          ...
          {currentStep === 2 && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Please authorize access to your insurance account details
              </p>
              <button
                onClick={() => {
          ...
          {currentStep === 3 && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Click below to generate your verifiable insurance credentials
              </p>
              <button
